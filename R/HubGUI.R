...
setMethod("makeToolbar", "HubGUI", function(gui, hub) {
  
  
})

setMethod("makeMainGUI", "HubGUI", function(gui, hub) {
  maingrp <- ggroup(horizontal=TRUE, container=getWidget(gui, hub, 'wingrp'), expand=TRUE)
